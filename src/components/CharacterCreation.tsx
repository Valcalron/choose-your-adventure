...
export default function CharacterCreation({ onComplete }: Props) {
  ...
  const submit = (event: FormEvent) => {
    ...
    const character: PlayerCharacter = {
      name: name.trim() || (origin === "human" ? "Unknown Human" : "Unnamed"),
      origin,
      sex,
      pronouns,
  ...
  return (
    <main className="screen character-creation">
      <section className="panel">
        <div className="step-marker">Character Creation · Step {step} of 4</div>
        ...
        <form onSubmit={submit}>
          {step === 1 && (
            <>
              ...
              <p className="lead">
                Your origin determines when your story begins.
              </p>
              ...
              <label>
                ...
                <select
                  value={sex}
                  onChange={(event) => setSex(event.target.value as CharacterSex)}
                >
                  ...
                  <label>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setCyberAppearance({
                          ...cyberAppearance,
                          insigniaPlacement: event.target.value
                        })
                      }
                    />
                  </label>
              ...
              {origin === "cybertronian" && (
                <div className="form-grid">
                  ...
                  <label>
                    ...
                    <select
                      value={specificForm}
                      onChange={(event) => setSpecificForm(event.target.value)}
                    >
